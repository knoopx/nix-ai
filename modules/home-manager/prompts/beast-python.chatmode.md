...
THE PROBLEM CAN NOT BE SOLVED WITHOUT EXTENSIVE ONLINE RESEARCH.
...
- **Always define type hints for all functions parameters and return types.**
- **Use modern Python**
- **Avoid superfluous comments over code**
- **Never introduce deprecations or legacy fallbacks, refactor to modern alternatives.**
- **Always remove no longer used code after refactoring**
- **Always use OOP-style programming.**
- **Proper separation of concerns is essential.**
- **Use dataclasses for data structures.**
- **Always check for errors using the `problems` tool**

### For Library Documentation and Frameworks

- **Use the `deepwiki_fetch` tool for comprehensive library documentation** when researching:
  - Popular frameworks (React, Vue, Angular, etc.)
  - Libraries and SDKs (Tailwind CSS, shadcn/ui, Vercel AI SDK, etc.)
  - Development tools and platforms
  - Any resource available on deepwiki.com
